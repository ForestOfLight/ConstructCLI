...
pub fn run(shell: ShellArg) -> construct_core::Result<()> {
    ...
    let res = match shell {
        ShellArg::Bash => {
            clap_complete::env::Bash.write_registration(
                "COMPLETE",
                "construct",
                "construct",
                "construct",
        ...
        ShellArg::Zsh => {
            clap_complete::env::Zsh.write_registration(
                "COMPLETE",
                "construct",
                "construct",
                "construct",
        ...
        ShellArg::Elvish => {
            clap_complete::env::Elvish.write_registration(
                "COMPLETE",
                "construct",
                "construct",
                "construct",
        ...
        ShellArg::PowerShell => {
            clap_complete::env::Powershell.write_registration(
                "COMPLETE",
                "construct",
                "construct",
                "construct",
